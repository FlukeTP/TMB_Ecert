 ...
 *         &lt;element ref="{urn:ifxforum-org:XSD:1}MediaAcctRef"/&gt;
...
public class MediaAcctModRqType {
    ...
    @XmlElement(name = "MediaAcctRef", required = true)
    protected MediaAcctRefType mediaAcctRef;
     ...
     *     
     */
    public MediaAcctRefType getMediaAcctRef() {
        return mediaAcctRef;
    }

    /**
     * Sets the value of the mediaAcctRef property.
     * 
     * @param value
     *     allowed object is
     *     {@link MediaAcctRefType }
     *     
     */
    public void setMediaAcctRef(MediaAcctRefType value) {
        this.mediaAcctRef = value;
    }
